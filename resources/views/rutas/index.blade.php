...
@section('title', 'Rutas Pindoor · Itinerarios por Valparaíso | Pindoor')
@section('canonical', route('rutas.index'))
@section('description', 'Rutas a pie por Valparaíso: itinerarios curados con los mejores miradores, cafés, murales y rincones de la ciudad.')
...
<div class="max-w-6xl mx-auto px-4 py-12 md:py-16">
    ...
    <div class="mb-12">
        ...
        <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">Rutas Pindoor</h1>
        <p class="mt-3 text-lg text-gray-500" style="font-family:'Lora',serif;">
            Itinerarios a pie para recorrer Valparaíso.
        </p>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-gray-100 px-8 py-20 text-center text-gray-400">
        ...
        <p class="font-semibold text-lg">Pronto habrá rutas aquí.</p>
    </div>
    @else
           ...
           class="group bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden
            ...
            <div class="p-6 flex flex-col flex-1">
                <p class="text-xs font-black uppercase tracking-widest text-[#fc5648] mb-2">
                    {{ $ruta->puntos->count() }} {{ $ruta->puntos->count() === 1 ? 'parada' : 'paradas' }}
                </p>
