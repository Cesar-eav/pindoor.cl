<x-guest-layout>
    ...
    {{-- Panel izquierdo desktop: teal, textos de operador turístico --}}
    <x-slot name="panelLeft">
        <div class="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden"
             style="background: linear-gradient(155deg, #0d9488 0%, #0f766e 45%, #115e59 100%)">
            ...
            <div class="relative z-10">
                <h1 class="text-white text-4xl font-bold leading-tight mb-4">
                    Lleva turistas<br>a los mejores lugares
                </h1>
                <p class="text-white/80 text-base leading-relaxed mb-8">
                    Únete como operador turístico y aparece en las fichas<br>de los lugares que visitas en tus tours.
                </p>
                <ul class="space-y-3">
                    <li class="flex items-center gap-3 text-white/80 text-sm">
                        ...
                        Perfil gratuito con tus datos y redes
                    </li>
                    <li class="flex items-center gap-3 text-white/80 text-sm">
                        <span class="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-white text-xs shrink-0">✓</span>
                        Asócialo a los miradores, museos y lugares que operas
                    </li>
                    <li class="flex items-center gap-3 text-white/80 text-sm">
                        <span class="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-white text-xs shrink-0">✓</span>
                        Contacto directo para reservas por WhatsApp
                    </li>
                </ul>
            </div>
    ...
    <div class="lg:hidden -mx-8 -mt-8 mb-8 rounded-t-2xl overflow-hidden"
        ...
        <div class="px-8 py-8">
            ...
            <h2 class="text-white text-xl font-bold leading-snug mb-2">Lleva turistas a los mejores lugares</h2>
            <p class="text-white/80 text-sm leading-relaxed mb-4">Únete como operador turístico y aparece en las fichas de los lugares que visitas.</p>
            <ul class="space-y-2">
                ...
                <li class="flex items-center gap-2 text-white/80 text-sm">
                    <span class="w-4 h-4 rounded-full bg-white/20 flex items-center justify-center text-white text-[10px] shrink-0">✓</span>
                    Asócialo a los lugares que operas
                </li>
                <li class="flex items-center gap-2 text-white/80 text-sm">
                    <span class="w-4 h-4 rounded-full bg-white/20 flex items-center justify-center text-white text-[10px] shrink-0">✓</span>
                    Contacto directo para reservas por WhatsApp
    ...
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-900">Regístrate como operador turístico</h2>
        <p class="text-sm text-gray-500 mt-1">Tours y visitas guiadas · Pindoor</p>
    </div>

    <a href="{{ route('auth.google', ['tipo' => 'operador']) }}"
    ...
    <form method="POST" action="{{ route('operador.register.store') }}">
        @csrf
        ...
        <div>
            <x-input-label for="name" value="Tu nombre o el de tu empresa de turismo" />
    ...
    <p class="mt-2 text-center text-sm text-gray-500">
        ¿Eres artista o agrupación cultural?
        <a href="{{ route('artista.register') }}" class="font-semibold text-[#fc5648] hover:underline">Únete a La Escena</a>
    </p>
    <p class="mt-2 text-center text-sm text-gray-500">
        ¿Ya tienes cuenta?
