...
<header class="text-center mb-1">
    ...
    <div class="hidden md:block relative">
        {{-- <img src="{{ asset('storage/portada.png') }}" class="w-full mx-auto mb-4 rounded shadow" /> --}}

        <!-- Redes sociales - Versión escritorio -->
        <div class="absolute top-0 right-4 flex gap-3">
            <a href="https://www.instagram.com/elpionerodevalparaiso/" target="_blank" rel="noopener"
               class="w-10 h-10 flex items-center justify-center bg-white/90 hover:bg-white rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110">
