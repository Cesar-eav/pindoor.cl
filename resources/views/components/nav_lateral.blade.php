...
<aside class="hidden md:flex flex-col w-56 fixed left-0 bottom-0 bg-white border-r border-gray-100 z-40 top-24">
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        ...
        @php
            ...
            $navItems = [
                ...
                [
                    ...
                    'label'  => __('ui.nav.rutas'),
                    'icon'   => '<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/><circle cx="12" cy="9" r="1.5" fill="currentColor" stroke="none"/></svg>',
        ...
        @php $navIds = ['nav-inicio', 'nav-explorar-mapa', 'nav-panoramas', 'nav-artistas', 'nav-experiencias', 'nav-blog', 'nav-rutas', 'nav-info', 'nav-contacto']; @endphp
