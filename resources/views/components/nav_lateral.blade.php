    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        ...
        @php
            ...
            $navItems = [
                ...
                //     'active' => request()->routeIs('artistas.index') || request()->routeIs('artista.show'),
                // ],
                [
        ...
        @php $navIds = ['nav-inicio', 'nav-explorar-mapa', 'nav-panoramas', 'nav-experiencias', 'nav-blog', 'nav-contacto']; @endphp
