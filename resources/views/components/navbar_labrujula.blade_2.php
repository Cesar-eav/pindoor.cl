...
<div class="flex w-full font-mono items-center justify-between bg-white border border-gray-300 text-[#fc5648] md:rounded-md px-6 py-3 md:mb-8 mb-0 sticky top-0 z-50 text-lg font-semibold">
    ...
    <button id="mobile-menu-button" class="lg:hidden text-[#fc5648] hover:text-[#fc5648] focus:outline-none pl-2">
        <!-- Ícono hamburguesa -->
    ...
    <!-- Menú móvil -->
    <div id="mobile-menu" class="hidden absolute top-full left-0 w-full bg-white text-[#fc5648] border border-gray-600  flex-col p-4 space-y-3">
