...
<div class="flex min-h-screen">
    ...
    {{-- Barra superior unificada: solo desktop, en todas las vistas --}}
    <x-barra-superior />

    {{-- Contenido principal --}}
    <div class="flex-1 min-w-0 md:ml-56 md:pt-24 pb-16 md:pb-0">
        <x-mobile.appbar>
            <x-slot:actions>
...
<div id="fab-menu"
    ...
    {{-- Instagram --}}
    <a href="https://www.instagram.com/pindoor.cl/" target="_blank" rel="noopener noreferrer" onclick="closeFab()"
       class="flex flex-col items-center gap-1.5 bg-white border border-gray-200 text-gray-700 px-5 py-3.5 rounded-2xl shadow-xl min-w-19">
        ...
        <span class="text-[10px] font-bold leading-none">{{ __('ui.nav.instagram') }}</span>
    </a>
