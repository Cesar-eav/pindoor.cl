<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crea tu perfil de artista o agrupación</h2>
    </x-slot>
    ...
    <div class="py-10">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <p class="text-sm text-gray-500 mb-6">Cuéntanos quién eres o de qué agrupación formas parte. Podrás completar el resto del perfil después.</p>
                ...
                <form action="{{ route('artista.crear') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">
                            Nombre artístico o de la agrupación <span class="text-red-500">*</span>
                        </label>
