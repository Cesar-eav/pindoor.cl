...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200 flex flex-col lg:flex-row items-start">

                <div class="mb-6 lg:mb-0 lg:mr-8 lg:w-1/3">
                    <img src="/storage/pionero_grande.png" alt="Logo El Pionero de Valparaíso"
                        class="w-60 md:w-full md:max-w-full h-auto">
                </div>

                <div class="lg:w-2/3">
                    <h3 class="text-lg font-semibold mb-4">Formulario de Contacto</h3>
                    ...
                    <form method="POST" action="{{ route('contacto.enviar') }}">
                        ...
                        <div class="mb-4">
                            <label for="correo" class="block text-gray-700 text-sm font-bold mb-2">Correo Electrónico
                                (Obligatorio):</label>
                        ...
                        <div class="mb-4">
                            <label for="telefono" class="block text-gray-700 text-sm font-bold mb-2">Teléfono
                                (Opcional):</label>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="motivo" name="motivo" rows="4"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('motivo') }}</textarea>
                            @error('motivo')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
