        ...
        <nav class="bg-gray-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex space-x-4 py-3">
                    ...
                    <a href="{{ url('columnistas-vue') }}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">
                        Columnistas
                    </a>
                </div>
            </div>
